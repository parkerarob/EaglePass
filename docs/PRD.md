...
* `studentId`, `teacherId`, `supportId`, `adminId`, `devId`, `name`, `role`, `assignment`, `restrictions`
...
* **Authentication:** Google SSO (OAuth 2.0) + Local Auth
