...
describe('declareReturn Cloud Function', () => {
  let testEnv: any;
  ...
  it('should close pass and log event (happy path)', async () => {
    const wrapped = testEnv.wrap(require('../src/index').declareReturn);
    ...
    expect(passSnap.data()?.state).toBe('IN_CLASS');
